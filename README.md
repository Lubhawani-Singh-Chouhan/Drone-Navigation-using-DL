...
* [`uav/`](python/uav/) is the main module that contains implementation of the controllers, environment representation, and all navigation modules and algorithms.

Files [`learn.py`](python/learn.py) and [`navigate.py`](python/navigate.py) are the main files used to, respectively, train and evaluate a neural network and navigate the drone.

## Results

All results obtained are explained in my [thesis report](latex/main.pdf).
